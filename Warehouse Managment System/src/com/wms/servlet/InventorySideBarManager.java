...
/**
 * Servlet implementation class InventorySideBarManager
 */
@WebServlet("/InventorySideBarManager")
public class InventorySideBarManager extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public InventorySideBarManager() {
		super();
